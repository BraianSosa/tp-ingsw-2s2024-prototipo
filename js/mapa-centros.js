  ...
  centros: [
    {
      id: 4,
      nombre: "Centro Lanús",
      coordenadas: [-34.689911360228706, -58.388476645631705],
      direccion: "Av. Hipólito Yrigoyen 2900, Lanus",
    },
    {
      id: 5,
      nombre: "Centro Quilmes",
      coordenadas: [-34.65866109685428, -58.37085364377857],
      direccion: "Av. Bartolomé Mitre 230, Quilmes, Provincia de Buenos Aires",
    },
    {
      id: 6,
      nombre: "Centro Avellaneda",
      coordenadas: [-34.65935822378025, -58.367936362506114],
      direccion: "Av. Bartolomé Mitre 470, Avellaneda, Provincia de Buenos Aires",
    },
  ],
  poligono: {
    color: "green",
  ...
  centros: [
    {
      id: 7,
      nombre: "Centro Morón",
      coordenadas: [-34.65045326120391, -58.61578148776799],
      direccion: "Almte. Guillermo Brown 450, B1708EFG Morón, Provincia de Buenos Aires",
    },
    {
      id: 8,
      nombre: "Centro San Justo",
      coordenadas: [-34.66048356855702, -58.58135278653012],
      direccion: "Almafuerte 820, San Justo, Provincia de Buenos Aires",
    },
    {
      id: 9,
      nombre: "Centro Merlo",
      coordenadas: [-34.68119660187421, -58.703239593254395],
      direccion: "Av. Calle Real 1500, Merlo",
    },
  ],
  poligono: {
    color: "red",
  ...
  centros: [
    {
      ...
      coordenadas: [-34.58716982193837, -58.41307218796125],
      direccion: "Av. Sta. Fe 3400, C1425 BGV, Cdad. Autónoma de Buenos Aires",
    },
    {
      id: 11,
      nombre: "Centro Recoleta",
      coordenadas: [-34.60781735509344, -58.396519459124605],
      direccion: "Junín 120, C1026ABD Cdad. Autónoma de Buenos Aires",
    },
    {
      id: 12,
      nombre: "Centro Belgrano",
      coordenadas: [-34.56835911844594, -58.448187030288956],
      direccion: "Av. Cabildo 1200, C1426AAY Cdad. Autónoma de Buenos Aires",
    },
  ],
  poligono: {
    color: "purple",
